...
<div class="topbar">
    ...
    <div class="topbar-right">
        <span class="topbar-user">
            ...
            <?php echo e(Auth::user()->nombre ?? Auth::user()->name); ?> <?php echo e(Auth::user()->apellido ?? ''); ?>
...
<aside class="sidebar">
    ...
    <a href="<?php echo e(route('admin.pre-registros.index')); ?>" class="nav-item c-blue">
        <i class="ti ti-clock"></i> Pre-registros
    </a>
    <a href="<?php echo e(route('admin.postulantes.index')); ?>" class="nav-item active">
    ...
    <a href="#" class="nav-item c-teal">
        <i class="ti ti-layout-grid"></i> Grupos
    </a>
    <a href="#" class="nav-item c-rose">
        <i class="ti ti-file-text"></i> Exámenes
    </a>
    <a href="#" class="nav-item c-blue">
        <i class="ti ti-building"></i> Convocatoria
    </a>

    <div class="nav-label">Sistema</div>
    <a href="#" class="nav-item c-purple">
...
<div class="page">
    ...
    <div class="conteos">
        <div class="conteo total">
            ...
            <div class="conteo-valor"><?php echo e($stats['total']); ?></div>
        </div>
        <div class="conteo reg">
            <div class="conteo-label"><i class="ti ti-clock"></i> Registrados</div>
            <div class="conteo-valor"><?php echo e($stats['registrados']); ?></div>
        </div>
        <div class="conteo pago">
            <div class="conteo-label"><i class="ti ti-circle-check"></i> Con Pago</div>
            <div class="conteo-valor"><?php echo e($stats['con_pago']); ?></div>
        </div>
        <div class="conteo ret">
            <div class="conteo-label"><i class="ti ti-x"></i> Retirados</div>
            <div class="conteo-valor"><?php echo e($stats['retirados']); ?></div>
        </div>
    </div>

    
    <form method="GET" action="<?php echo e(route('admin.postulantes.index')); ?>" class="filtros">
        <div>
            <label>Buscar</label>
            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Nombre, CI o código...">
        </div>
        <div>
            <label>Estado</label>
            <select name="estado">
                <option value="">Todos</option>
                <option value="REGISTRADO" <?php echo e(request('estado')=='REGISTRADO'?'selected':''); ?>>Registrado</option>
                <option value="CON_PAGO"   <?php echo e(request('estado')=='CON_PAGO'?'selected':''); ?>>Con Pago</option>
        ...
        <div>
            ...
            <select name="turno">
                <option value="">Todos</option>
                <option value="MAÑANA" <?php echo e(request('turno')=='MAÑANA'?'selected':''); ?>>Mañana</option>
                <option value="TARDE"  <?php echo e(request('turno')=='TARDE'?'selected':''); ?>>Tarde</option>
                <option value="NOCHE"  <?php echo e(request('turno')=='NOCHE'?'selected':''); ?>>Noche</option>
            </select>
        </div>
        <div>
            <label>Carrera</label>
        ...
        <div style="display:flex;gap:8px">
            ...
            <?php if(request()->hasAny(['search','estado','turno','carrera_id'])): ?>
                <a href="<?php echo e(route('admin.postulantes.index')); ?>" class="btn-limpiar">
    ...
    <div class="card">
        <div class="card-header">
            <span class="card-info">
                Mostrando <?php echo e($postulantes->firstItem() ?? 0); ?>–<?php echo e($postulantes->lastItem() ?? 0); ?>

                de <?php echo e($postulantes->total()); ?> postulantes
            </span>
            <a href="<?php echo e(route('admin.postulantes.export')); ?>" class="btn-export">
                <i class="ti ti-download"></i> Exportar
            </a>
        </div>

        <?php if($postulantes->isEmpty()): ?>
            <div class="empty">
        ...
        <table>
            ...
            <tbody>
                <?php $__currentLoopData = $postulantes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td style="color:#94a3b8"><?php echo e($postulantes->firstItem() + $i); ?></td>
                    <td>
                        <div style="display:flex;align-items:center;gap:10px">
                            <div class="avatar">
                                <?php echo e(strtoupper(substr($p->nombre,0,1).substr($p->apellido,0,1))); ?>

                            </div>
                            <div>
                                <div style="font-weight:500"><?php echo e($p->nombre); ?> <?php echo e($p->apellido); ?></div>
                                <div style="color:#94a3b8;font-size:11px"><?php echo e($p->email); ?></div>
                            </div>
                        </div>
                    </td>
                    <td><span class="codigo"><?php echo e($p->codigo_estudiante); ?></span></td>
                    <td style="font-size:12px;color:#64748b"><?php echo e($p->ci); ?></td>
                    <td>
                        <div style="font-size:13px"><?php echo e($p->carreraPref1->nombre ?? '—'); ?></div>
                        <?php if($p->carreraPref2): ?>
                            <div style="font-size:11px;color:#94a3b8">2ª: <?php echo e($p->carreraPref2->nombre); ?></div>
                        <?php endif; ?>
                    </td>
                    <td>
                        <?php
                        ...
                        ?>
                        <span class="badge <?php echo e($turnoClass[$p->turno_asignado] ?? ''); ?>">
                            <?php echo e(ucfirst(strtolower($p->turno_asignado))); ?>

                        </span>
                    </td>
                    <td style="font-size:12px;color:#64748b">
                        <?php echo e($p->grupoPostulante?->grupo?->codigo_grupo ?? '—'); ?>
                    ...
                    <td>
                        ...
                        ?>
                        <span class="badge <?php echo e($estadoClass[$p->estado] ?? ''); ?>">
                            <?php echo e(ucfirst(strtolower(str_replace('_',' ',$p->estado)))); ?>

                        </span>
                    </td>
                    <td>
                        <div style="display:flex;gap:6px">
                            <a href="<?php echo e(route('admin.postulantes.show', $p->id)); ?>" class="btn btn-info">
                                <i class="ti ti-eye"></i> Ver
                            </a>
                            <a href="<?php echo e(route('admin.postulantes.edit', $p->id)); ?>" class="btn btn-warn">
                                <i class="ti ti-pencil"></i> Editar
                            </a>
                            <form method="POST" action="<?php echo e(route('admin.postulantes.destroy', $p->id)); ?>"
                                  onsubmit="return confirm('¿Eliminar a <?php echo e($p->nombre); ?> <?php echo e($p->apellido); ?>?')">
        ...
        <?php if($postulantes->hasPages()): ?>
        <div class="pagination">
            <span class="pag-info">Página <?php echo e($postulantes->currentPage()); ?> de <?php echo e($postulantes->lastPage()); ?></span>
            <div class="pag-links">
                <?php if($postulantes->onFirstPage()): ?>
                    <span class="pag-btn disabled">← Anterior</span>
                <?php else: ?>
                    <a href="<?php echo e($postulantes->previousPageUrl()); ?>" class="pag-btn">← Anterior</a>
                <?php endif; ?>

                <?php $__currentLoopData = $postulantes->getUrlRange(max(1,$postulantes->currentPage()-2), min($postulantes->lastPage(),$postulantes->currentPage()+2)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e($url); ?>" class="pag-btn <?php echo e($page == $postulantes->currentPage() ? 'active' : ''); ?>"><?php echo e($page); ?></a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                <?php if($postulantes->hasMorePages()): ?>
                    <a href="<?php echo e($postulantes->nextPageUrl()); ?>" class="pag-btn">Siguiente →</a>
                <?php else: ?>
...
</html><?php /**PATH C:\Users\pc\Desktop\Jair torrico\semestre\sistemas de informacion\CUP-main\resources\views/admin/postulantes/index.blade.php ENDPATH**/ ?>