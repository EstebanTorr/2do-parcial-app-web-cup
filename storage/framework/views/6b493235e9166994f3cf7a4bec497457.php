...
<head>
    ...
    <title>CUP — <?php echo e($titulo); ?></title>
...
<aside class="sidebar">
    ...
    <a href="<?php echo e(route('admin.pre-registros.index')); ?>" class="nav-item c-amber <?php echo e($titulo === 'Pre-registros' ? 'active' : ''); ?>">
        <i class="ti ti-clock"></i> Pre-registros
    </a>
    <a href="<?php echo e(route('admin.postulantes.index')); ?>" class="nav-item c-blue <?php echo e($titulo === 'Postulantes' ? 'active' : ''); ?>">
        <i class="ti ti-id-badge"></i> Postulantes
    </a>
    <a href="<?php echo e(route('admin.docentes.index')); ?>" class="nav-item c-purple <?php echo e($titulo === 'Docentes' ? 'active' : ''); ?>">
        <i class="ti ti-chalkboard"></i> Docentes
    </a>

    <div class="nav-label">Académico</div>
    <a href="<?php echo e(route('admin.grupos.index')); ?>" class="nav-item c-teal <?php echo e($titulo === 'Grupos' ? 'active' : ''); ?>">
        <i class="ti ti-layout-grid"></i> Grupos
    </a>
    <a href="<?php echo e(route('admin.examenes.index')); ?>" class="nav-item c-rose <?php echo e($titulo === 'Exámenes' ? 'active' : ''); ?>">
        <i class="ti ti-file-text"></i> Exámenes
    </a>
    <a href="<?php echo e(route('admin.convocatorias.index')); ?>" class="nav-item c-blue <?php echo e($titulo === 'Convocatorias' ? 'active' : ''); ?>">
        <i class="ti ti-building"></i> Convocatoria
    </a>

    <div class="nav-label">Sistema</div>
    <a href="<?php echo e(route('admin.reportes.index')); ?>" class="nav-item c-purple <?php echo e($titulo === 'Reportes' ? 'active' : ''); ?>">
...
<main class="main">
    <div class="empty-state">
        <div class="empty-icon">
            <i class="ti <?php echo e($icono); ?>"></i>
        </div>
        <div class="badge-soon">
            <i class="ti ti-clock" style="font-size:13px"></i>
            En desarrollo
        </div>
        <h2>Módulo de <?php echo e($titulo); ?></h2>
...
</html><?php /**PATH C:\Users\pc\Desktop\Jair torrico\semestre\sistemas de informacion\CUP-main\resources\views/admin/coming-soon.blade.php ENDPATH**/ ?>