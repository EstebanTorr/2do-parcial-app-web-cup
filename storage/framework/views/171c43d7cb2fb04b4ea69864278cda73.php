...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="<?php echo e(route('postulante.dashboard')); ?>" class="menu-item active">
                <i class="ti ti-smart-home"></i>
                <span>Inicio</span>
            </a>
            <a href="<?php echo e(route('postulante.notas')); ?>" class="menu-item">
                <i class="ti ti-file-analytics"></i>
                <span>Mis Notas</span>
            </a>
            <a href="<?php echo e(route('postulante.grupo')); ?>" class="menu-item">
                <i class="ti ti-users-group"></i>
                <span>Mi Grupo</span>
            </a>
        </nav>
        <div class="sidebar-footer">
            UAGRM &copy; <?php echo e(date('Y')); ?>
    ...
    <div class="main-content">
        ...
        <header class="topbar">
            <div class="welcome-msg">
                <h1>Hola, <?php echo e($postulante->nombre); ?></h1>
                <p>Bienvenido al sistema de admisiones CUP de la FICCT.</p>
            </div>
            <div class="user-profile">
                <div class="avatar">
                    <?php echo e($postulante->iniciales); ?>

                </div>
                <div class="user-info">
                    <div class="name"><?php echo e($postulante->nombre_completo); ?></div>
                    <div class="code">Reg: <?php echo e($postulante->codigo_estudiante); ?></div>
                </div>
                <form method="POST" action="<?php echo e(route('logout')); ?>" style="margin-left: 10px;">
                    <?php echo csrf_field(); ?>
        ...
        <main class="content-wrapper">
            ...
            <?php if($estadisticas['estado'] === 'APROBADO' || $estadisticas['estado'] === 'ADMITIDO'): ?>
                <div class="status-hero aprobado">
                    <div class="status-content">
                        <div class="status-icon">🎉</div>
                        <div class="status-text">
                            <h2>¡Felicidades! Has sido Admitido</h2>
                            <p>Superaste exitosamente el proceso de admisión. Has sido asignado a la carrera de <strong><?php echo e($estadisticas['carrera_asignada']?->nombre ?? 'Carrera elegida'); ?></strong>.</p>
                        </div>
                    </div>
                    <div class="status-badge">Admitido</div>
                </div>
            <?php elseif($estadisticas['estado'] === 'RECHAZADO' || $estadisticas['estado'] === 'REPROBADO_CUP'): ?>
            ...
            <div class="stats-grid">
                <div class="stat-card primary">
                    <div class="stat-info">
                        ...
                        <div class="value"><?php echo e(number_format($estadisticas['promedio'] ?? 0, 2)); ?> pts</div>
                ...
                <div class="stat-card success">
                    <div class="stat-info">
                        ...
                        <div class="value"><?php echo e($estadisticas['notas_registradas']); ?></div>
                ...
                <div class="stat-card warning">
                    <div class="stat-info">
                        ...
                        <div class="value"><?php echo e($estadisticas['grupo']?->numero_grupo ?? 'Sin Asignar'); ?></div>
                        <p class="desc">Turno: <?php echo e($postulante->turno_asignado ?? 'Pendiente'); ?></p>
                    </div>
                    <div class="stat-icon">
                        <i class="ti ti-id"></i>
                    </div>
                ...
                <div class="stat-card">
                    <div class="stat-info">
                        <h3>Ranking</h3>
                        <div class="value">#<?php echo e($estadisticas['posicion_ranking'] ?? '—'); ?></div>
                ...
                <div class="card">
                    ...
                    <div class="info-list">
                        <div class="info-item">
                            ...
                            <div class="info-value"><?php echo e($postulante->nombre_completo); ?></div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Documento de Identidad</div>
                            <div class="info-value"><?php echo e($postulante->ci); ?></div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Correo Electrónico</div>
                            <div class="info-value"><?php echo e($postulante->email); ?></div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Teléfono de Contacto</div>
                            <div class="info-value"><?php echo e($postulante->telefono); ?></div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Colegio de Procedencia</div>
                            <div class="info-value"><?php echo e($postulante->colegio_nombre ?? 'No registrado'); ?></div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Convocatoria Activa</div>
                            <div class="info-value"><?php echo e($postulante->convocatoria?->gestion ?? 'Gestión actual'); ?></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="pref-box">
                        <div class="pref-item">
                            ...
                            <div class="pref-details">
                                <h4><?php echo e($postulante->carreraPref1?->nombre ?? 'Primera opción'); ?></h4>
                        ...
                        <div class="pref-item second">
                            ...
                            <div class="pref-details">
                                <h4><?php echo e($postulante->carreraPref2?->nombre ?? 'Segunda opción'); ?></h4>
...
<?php /**PATH C:\Users\pc\Desktop\Jair torrico\semestre\sistemas de informacion\CUP-main\resources\views/postulante/dashboard.blade.php ENDPATH**/ ?>