...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="<?php echo e(route('postulante.dashboard')); ?>" class="menu-item">
                <i class="ti ti-smart-home"></i>
                <span>Inicio</span>
            </a>
            <a href="<?php echo e(route('postulante.notas')); ?>" class="menu-item active">
        ...
        <main class="content-wrapper">
            ...
            <?php else: ?>
                <div class="card">
                    ...
                    <?php $__currentLoopData = $notas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $materiaId => $grupoNotas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div class="materia-section">
                            <div class="materia-header">
                                <div>
                                    <h3 class="materia-name"><?php echo e($materia->nombre); ?></h3>
                                    <div class="materia-docente">
                                        <i class="ti ti-school-bell"></i> Docente: 
                                        <?php echo e($docente ? $docente->nombre . ' ' . $docente->apellido : 'Por designar'); ?>
                            ...
                            <table>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $grupoNotas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($nota->created_at ? $nota->created_at->format('d/m/Y H:i') : '—'); ?></td>
                                        <td style="font-weight: 700; font-size: 15px;"><?php echo e(number_format($nota->calificacion, 2)); ?> pts</td>
                                        <td>
                                            <span class="score-badge <?php echo e($nota->calificacion >= 51 ? 'approved' : 'failed'); ?>">
                                                <?php echo e($nota->calificacion >= 51 ? 'Aprobado' : 'Reprobado'); ?>

                                            </span>
                                        </td>
                                        <td style="color: #64748b; font-style: italic;"><?php echo e($nota->observaciones ?? 'Ninguna'); ?></td>
                                    </tr>
...
<?php /**PATH C:\Users\pc\Desktop\Jair torrico\semestre\sistemas de informacion\CUP-main\resources\views/postulante/notas.blade.php ENDPATH**/ ?>