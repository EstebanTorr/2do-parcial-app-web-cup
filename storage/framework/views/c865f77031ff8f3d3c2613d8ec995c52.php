...
<div class="page">
    ...
    <div class="form-card">
        ...
        <form method="POST" action="<?php echo e(route('admin.convocatorias.store')); ?>">
            <?php echo csrf_field(); ?>
            <div class="grid-2" style="margin-bottom:16px">
                <div class="field" style="grid-column: span 2">
                    <label>Nombre de la convocatoria *</label>
                    <input type="text" name="nombre" value="<?php echo e(old('nombre', 'Gestión ' . date('Y'))); ?>" required placeholder="Ej: Gestión 2025 — Primer Semestre">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="field">
                    ...
                    <input type="number" name="monto_pago" value="<?php echo e(old('monto_pago', '700.00')); ?>" step="0.01" min="0" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid-2" style="margin-bottom:20px">
                <div class="field">
                    ...
                    <input type="number" name="cupo_total" value="<?php echo e(old('cupo_total', '300')); ?>" min="1">
                </div>
                <div class="field">
    ...
    <div class="card">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td style="font-weight:500"><?php echo e($conv->nombre); ?></td>
                    <td><?php echo e(\Carbon\Carbon::parse($conv->fecha_inicio)->format('d/m/Y')); ?></td>
                    <td><?php echo e(\Carbon\Carbon::parse($conv->fecha_fin)->format('d/m/Y')); ?></td>
                    <td>Bs. <?php echo e(number_format($conv->monto_pago, 2)); ?></td>
                    <td><?php echo e($conv->cupo_total); ?></td>
                    <td>
                        <span class="badge <?php echo e($conv->estado === 'ACTIVA' ? 'badge-activa' : ($conv->estado === 'PLANIFICADA' ? 'badge-planif' : 'badge-concluida')); ?>">
                            <i class="ti <?php echo e($conv->estado === 'ACTIVA' ? 'ti-circle-check' : ($conv->estado === 'PLANIFICADA' ? 'ti-clock' : 'ti-circle-x')); ?>"></i>
                            <?php echo e($conv->estado); ?>

                        </span>
                    </td>
                    <td>
                        <div style="display:flex;gap:6px;flex-wrap:wrap">
                            <?php if($conv->estado === 'PLANIFICADA'): ?>
                            <a href="<?php echo e(route('admin.convocatorias.edit', $conv->id)); ?>" class="btn-sm btn-editar-planif">
                                <i class="ti ti-pencil"></i> Editar
                            </a>
                            <form method="POST" action="<?php echo e(route('admin.convocatorias.activar', $conv->id)); ?>"
                            ...
                            <a href="<?php echo e(route('admin.convocatorias.edit', $conv->id)); ?>" class="btn-sm btn-editar-activa">
                                <i class="ti ti-pencil"></i> Editar
                            </a>
                            <form method="POST" action="<?php echo e(route('admin.convocatorias.concluir', $conv->id)); ?>"
...
</html><?php /**PATH C:\Users\pc\Desktop\Jair torrico\semestre\sistemas de informacion\CUP-main\resources\views/admin/convocatorias/index.blade.php ENDPATH**/ ?>