...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'CUP — FICCT'); ?></title>
...
<div class="flex h-screen overflow-hidden">
    ...
    <aside id="sidebar"
        ...
        <div class="h-14 flex items-center px-5 border-b border-white/10">
            <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-2 text-white font-bold text-base tracking-wide">
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-5">
            ...
            <div>
                ...
                <ul class="space-y-0.5">
                    <li>
                        <a href="<?php echo e(route('dashboard')); ?>"
                           class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition
                                  <?php echo e(request()->routeIs('dashboard') ? 'bg-white/15 text-white' : 'text-blue-100 hover:bg-white/10 hover:text-white'); ?>">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.pre-registros.index')); ?>"
                           class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition
                                  <?php echo e(request()->routeIs('admin.pre-registros.*') ? 'bg-white/15 text-white' : 'text-blue-100 hover:bg-white/10 hover:text-white'); ?>">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.postulantes.index')); ?>"
                           class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition
                                  <?php echo e(request()->routeIs('admin.postulantes.*') ? 'bg-white/15 text-white' : 'text-blue-100 hover:bg-white/10 hover:text-white'); ?>">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.docentes.index')); ?>"
                           class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition
                                  <?php echo e(request()->routeIs('admin.docentes.*') ? 'bg-white/15 text-white' : 'text-blue-100 hover:bg-white/10 hover:text-white'); ?>">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <div>
                ...
                <ul class="space-y-0.5">
                    <li>
                        <a href="<?php echo e(route('admin.grupos.index')); ?>"
                           class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition
                                  <?php echo e(request()->routeIs('admin.grupos.*') ? 'bg-white/15 text-white' : 'text-blue-100 hover:bg-white/10 hover:text-white'); ?>">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.examenes.index')); ?>"
                           class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition
                                  <?php echo e(request()->routeIs('admin.examenes.*') ? 'bg-white/15 text-white' : 'text-blue-100 hover:bg-white/10 hover:text-white'); ?>">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.convocatorias.index')); ?>"
                           class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition
                                  <?php echo e(request()->routeIs('admin.convocatorias.*') ? 'bg-white/15 text-white' : 'text-blue-100 hover:bg-white/10 hover:text-white'); ?>">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <ul class="space-y-0.5">
                    <li>
                        <a href="<?php echo e(route('admin.reportes.index')); ?>"
                           class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition
                                  <?php echo e(request()->routeIs('admin.reportes.*') ? 'bg-white/15 text-white' : 'text-blue-100 hover:bg-white/10 hover:text-white'); ?>">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <div class="px-4 py-3 border-t border-white/10">
            <p class="text-[10px] text-blue-300/40 text-center">UAGRM © <?php echo e(date('Y')); ?></p>
        </div>
    </aside>
        ...
        <header class="h-14 bg-[#1a3353] flex items-center justify-between px-6 flex-shrink-0">
            ...
            <div class="flex items-center gap-3">
                <div class="flex items-center gap-2 text-white text-sm">
                    ...
                    <span class="font-medium"><?php echo e(Auth::user()->nombre ?? Auth::user()->name); ?> <?php echo e(Auth::user()->apellido ?? ''); ?></span>
                </div>
...
</html><?php /**PATH C:\Users\pc\Desktop\Jair torrico\semestre\sistemas de informacion\CUP-main\resources\views/layouts/admin.blade.php ENDPATH**/ ?>